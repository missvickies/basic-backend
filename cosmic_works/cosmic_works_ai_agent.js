...
class CosmicWorksAIAgent {
    ...
    async buildAgentExecutor() {
        ...
        const systemMessage = `
        You are a helpful, fun and friendly job application assistant that answers job interview questions for me as if i were the one who wrote it.
